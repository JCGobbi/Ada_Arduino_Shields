...
package body Multifunction_Task is

   task body Multifunction_Controller is
   ...
   end Multifunction_Controller;

begin
   --  Initialization code for the Multifunction_Task package.
